...
[ ] Emergency contact info saved (recruiter phone/email)
```

### Technical Setup (by 8 PM)
...
[ ] Phone number ready for backup dial-in
```
...
[ ] Whiteboard marker experience (practice writing)
```

### Physical Preparation (by 9 PM)

```
[ ] Laid out professional outfit
[ ] Prepared water and snacks
[ ] Set multiple alarms (at least 2)
[ ] Reviewed commute time (onsite) or login procedure (virtual)
```

### Mental Preparation (9-10 PM)
...
[X] DON'T scroll social media before bed
```
...
[ ] Confirm all logistics one more time
```
...
[ ] For onsite: Arrive at building 10 minutes early
```

### Deep Breathing Exercise (5 minutes before)
...
[ ] Have pen and paper ready (or text editor open)
```

### Problem Presentation Phase (3-8 minutes)
...
[ ] Think about 2-3 test cases before coding
```

**Red flags that indicate you might be misunderstanding:**
...
1. Pause and breathe (it's okay to be silent for 30 seconds)
2. Re-read the problem constraints
3. Think about brute force
4. Consider simpler versions
5. Ask for a hint: "Could you point me in the right direction?"
...
1. Say: "I see there's an issue. Let me trace through..."
2. Walk through code line by line
3. Identify the bug
4. Fix it and explain why
5. Re-test
...
[ ] Get good sleep
[ ] Wait for recruiter follow-up (usually 1-2 weeks)
```
...
1. **You are prepared.** You've studied the patterns and solved the problems.

2. **You belong here.** Google invited you because your resume showed promise.

3. **You will think clearly.** The patterns you've practiced will come to you.

4. **You will communicate well.** You've practiced explaining your thinking.

5. **You can handle anything.** Even if stuck, you know how to recover.
...
Interview Platform Support: ____________
```
...
*You've prepared for this. Trust your training and show them what you can do. Good luck!*
